 ...
 * Date: 2018/3/15
 */
var renderServerMetaInfo$1 = renderServerMetaInfo = function (context, metaInfo) {
  var this$1 = this;
...
VueMetaInfo.install = function (Vue) {
  Vue.mixin({
    ...
    created: function created () {
      ...
      console.log(renderServerMetaInfo$1);
      renderServerMetaInfo$1(this.$ssrContext, this.$metaInfo);
    },
